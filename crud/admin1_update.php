    ...
    header('Location:login.php');
        ...
        $conn=mysqli_connect('localhost','root','','db');
            ...
            $images = implode(",",$images);
               ...
               $sql = "UPDATE `admin1` SET `name`='$name',`age`='$age',`gender`='$gender',`hobbies`='$hobbies',`city`='$city', `file`='".$images."' WHERE `admin1_id`='$id'"; 
        ...
        if (isset($_GET['admin1_id'])) 
        {
            ...
            $sql = "SELECT * FROM `admin1` WHERE `admin1_id`='$id'";
                ...
                <td><!-- <img src="photo/<?php echo $file_name;?>" width="100"> -->
                    <?php  $images=explode(',',$file_name); 
                                  ...
                                  Click here to remove files<br>
                                   <a href="remove.php?image=<?php echo "$image"; ?>&admin1_id=<?php echo $admin1_id; ?>" onclick="return confirm('Are you sure to remove all files ?')">Remove all files</a>
                </td></td></tr>
                <tr><td><input type="submit" name="update1" value="update">&nbsp;<a href="logout.php">logout</a></td></tr>
                </table>
        </form>
        </body>
        </html>
